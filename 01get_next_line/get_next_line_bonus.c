...
/*   Updated: 2023/04/19 17:20:39 by donglee2         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
char	*rm_node(int fd, t_list **head_node_ptr)
{
	t_list	*cur_node;
	t_list	*prev_node;
...
char	*cut_line(int fd, t_list **head_node_ptr, t_list *node)
{
	char	*ret_line;
	char	*tmp;
	ssize_t	idx;
...
// 	int fd4 = open("4.txt", O_RDONLY);
// 	int fd5 = open("5.txt", O_RDONLY);
