...
/*   Updated: 2023/06/14 19:41:33 by donglee2         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_over_3nodes(t_list **lst_a, t_list **lst_b)
{
	...
	// printf("make_indexed_lst complete\n");
	// print(*lst_a, *lst_b);
	ready_to_greedy(lst_a, lst_b);
	// printf("ready_to_greedy complete\n");
	// print(*lst_a, *lst_b);
	sort_3nodes(lst_a);
	// printf("sort_3nodes complete\n");
	// print(*lst_a, *lst_b);
	info_init(info);
	// printf("info_init complete\n");
	// print(*lst_a, *lst_b);
	while (*lst_b)
	{
